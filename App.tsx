...
import { DEFAULT_CONFIG, DEFAULT_AUDIO_CONFIG } from './constants';
...
const App: React.FC = () => {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden bg-white font-sans text-gray-900">
      {/* 游戏画布层 - 始终渲染 */}
      <SimulationCanvas config={config} audioConfig={audioConfig} isPaused={uiState !== 'game'} />
      ...
      {uiState === 'settings' && (
        <div className="absolute inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col">
            <div className="p-6 bg-gradient-to-r from-emerald-500 to-teal-600 flex justify-between items-center shrink-0">
            ...
            <div className="p-6 overflow-y-auto">
              <Controls
                ...
                onAudioChange={handleAudioConfigChange}
                onReset={handleReset}
              />
            </div>
          </div>
